...
(function () {
  ...
  function updatePlayer(dt) {
    ...
    p.iframes -= dt; p.hurtT -= dt; if (p.atk > 0) p.atk -= dt * 4.2; if (p.swing > 0) p.swing -= dt * 3.4;
    // 허기 & 회복
  ...
  Game.render = function (ctx, W, H, dpr) {
    ...
    const pc = { x: p.x, y: p.y, t: p.t, walk: p.walk, moving: p.moving, facing: p.facing, pal: S.char.pal, hurtT: p.hurtT, dashT: p.dashT, swing: p.swing, atk: p.atk, seed: 0 };
